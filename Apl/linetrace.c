...
bool_t judge_blue(){
    ...
    if(( crnt_rgb_line.r >=15 && crnt_rgb_line.r <=110 ) && ( crnt_rgb_line.g >=40 && crnt_rgb_line.g <=130 ) && ( crnt_rgb_line.b >=80 && crnt_rgb_line.b <=255 )&& ( reflection >=25 && reflection <=100 )  ){
...
bool_t judge_black(){
    ...
    printf("ref = %d | r = %d | g = %d | b = %d\n",reflection, crnt_rgb_line.r, crnt_rgb_line.g, crnt_rgb_line.b);
    if(( crnt_rgb_line.r >=10 && crnt_rgb_line.r <=90 ) && ( crnt_rgb_line.g >=10 && crnt_rgb_line.g <=110 ) && ( crnt_rgb_line.b >=10 && crnt_rgb_line.b <=110 )&& ( reflection >=5 && reflection <=80 )){
