...
extern int hello_neo(){
    ...
    // 定数宣言（目標座標の配列
    /* SIM上の座標を修正。*/
    static float x_pos_target[8]={ 420.0, 520.0, 240.0,-220.0,-780.0,- 560.0,-260.0,-300.0};
    static float y_pos_target[8]={-140.0,-580.0,-860.0,-760.0,-720.0,-1300.0,-720.0,-400.0};
