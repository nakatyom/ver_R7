...
extern int hello_neo(){
    ...
    /* SIM上の座標を修正。*/
    #define NEO_LOOP 11
    static float x_pos_target[NEO_LOOP]={ 420.0, 520.0, 240.0,-220.0,-780.0,- 560.0,-260.0,-300.0,100.0,    0.0,  5000.0};
    static float y_pos_target[NEO_LOOP]={-140.0,-580.0,-860.0,-760.0,-720.0,-1300.0,-900.0,-400.0,  0.0,-2200.0, -2200.0};
